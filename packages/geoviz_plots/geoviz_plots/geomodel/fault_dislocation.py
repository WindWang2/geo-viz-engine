"""Fault cutting and dislocation engine for geological surfaces (headless numpy).

Promoted verbatim from ``paleo_workbench/viz/geomodel/fault_dislocation.py``.
