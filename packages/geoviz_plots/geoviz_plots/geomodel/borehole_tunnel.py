"""Borehole trajectory segmentation and swept-tunnel tube meshing (headless numpy).

Promoted verbatim from ``paleo_workbench/viz/geomodel/borehole_tunnel.py``: pure
geometry generation belongs to the visualization engine, not to the workbench.
No Qt / OpenGL dependency — safe to call from worker threads.
"""
